...
REAL(KIND=8):: eff_index,eff_indexT,eff_indexI,eff_indexIb,eff_indexIs,eff_indexS

CALL sub_1(eff_index,eff_indexT,eff_indexI,eff_indexIb,eff_indexIs,eff_indexS)
...
REAL(KIND=8):: eff_indexT,eff_indexI,eff_indexIb,eff_indexIs,eff_indexS
...
!                END IF
            ...
            IF (eff_index .ge. mineff_index) THEN
                ii=ii+1
                WRITE(10)(par(j),j=1,n_par),eff_index,eff_indexT,eff_indexI,eff_indexIb,eff_indexIs
            END IF
        ELSE
	        fit(k)=-1e30
        ENDIF
    ...
    DO k=1,n_particles
        ...
        END IF
    END DO
    IF (count .ge. (0.95*n_particles)) THEN           ! 1 --> 100 °/o of npc
...
INTEGER :: i, j
REAL(KIND=8):: fit, foptim, eff_index,eff_indexT,eff_indexI, eff_indexIb,eff_indexIs,eff_indexS
...
!        END IF
    ...
    IF (eff_index .ge. mineff_index) THEN
        ii=ii+1
        WRITE(10)(par(j),j=1,n_par),eff_index,eff_indexT,eff_indexI
    END IF
